...
public class TransactionBehaviorTest extends AbstractRobustnessTest {
	...
	@Test public void transactionalReader() throws Exception {
		...
		System.out.println("read "+exec.getStepExecutions().iterator().next().getReadCount());
		System.out.println("written "+exec.getStepExecutions().iterator().next().getWriteCount());
		System.out.println("skip written "+exec.getStepExecutions().iterator().next().getWriteSkipCount());
		System.out.println("skip written "+exec.getStepExecutions().iterator().next());
		System.out.println("queue "+productQueueView.getQueueSize());
	}
