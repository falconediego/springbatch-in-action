 ...
 *
 */
public class JobExplorerSupport {

	public void jobExplorer(JobExplorer jobExplorer) throws Exception {
	...
	private List<JobExecution> getFailedJobExecutions(JobExplorer jobExplorer, String jobName) {
	...
	@Test public void findFailedJobExecutions(JobExplorer jobExplorer) throws Exception {
		System.out.println("#######################");
		List<String> jobNames = jobExplorer.getJobNames();
		for (String jobName : jobNames) {
			System.out.println(jobName+" - "+getFailedJobExecutions(jobExplorer, jobName).size());
			List<JobExecution> failedJobExecutions = getFailedJobExecutions(jobExplorer, jobName);
	...
	@Test public void findSkipsDuringJobExecutions(JobExplorer jobExplorer) throws Exception {
		System.out.println("#######################");
		List<String> jobNames = jobExplorer.getJobNames();
		for (String jobName : jobNames) {
			System.out.println(jobName+" - "+getFailedJobExecutions(jobExplorer, jobName).size());
