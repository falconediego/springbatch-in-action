...
public class WebTest {
	...
	private static final String BASE_URL = "http://localhost:8089/sbiach05/joblauncher";
	...
	private void startWebContainer() throws Exception {
		...
		wac.setContextPath("/sbiach05");
		wac.setWar("./src/test/resources/com/manning/sbia/ch05/web/webapp/");
